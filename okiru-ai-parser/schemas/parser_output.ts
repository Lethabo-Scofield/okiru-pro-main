...
export const parserOutputSchema = z.object({
  ...
  supplier_rows: z.array(z.object({
    ...
    black_women_ownership: z.number().nullable().default(null),
    enterprise_type: z.enum(['eme', 'qse', 'generic']).nullable().default(null),
    calculator_fields: z.record(z.unknown()),
    status: z.enum(['passed', 'review_required']),
    issues: z.array(z.string()),
  })).default([]),
  measured_procurement_spend: z.number().nullable().default(null),
  validation: z.object({
    passed: z.boolean(),
