...
const sectorConfigs = [
  { sectorCode: "RCOGP", scorecardType: "Generic", totalMaxPoints: 135, pillarConfigs: { ownership: { maxPoints: 25 }, managementControl: { maxPoints: 20 }, employmentEquity: { maxPoints: 0 }, skillsDevelopment: { maxPoints: 20 }, preferentialProcurement: { maxPoints: 25 }, enterpriseDevelopment: { maxPoints: 5 }, socioEconomicDevelopment: { maxPoints: 5 }, yesInitiative: { maxPoints: 3 } } },
