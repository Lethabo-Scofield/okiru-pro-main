                ...
                <>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button onClick={async () => {
                      if (!canContinueAfterQuote || isSavingSession) return;
                    ...
                    }} disabled={!canContinueAfterQuote || isSavingSession}
                      ...
                      {isSavingSession ? <><Loader2 className="w-3.5 h-3.5 mr-2 inline-block animate-spin" />Saving...</> : quoteLoading ? 'Preparing quote...' : !parserQuote ? 'Quote required' : !paymentPlaceholderVisible ? 'Proceed to payment first' : 'Extract from documents'}
                    </button>
                  </div>
                </>
              )}
