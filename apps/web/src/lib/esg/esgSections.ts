...
export const ESG_INPUT_SECTIONS: EsgSectionDef[] = [
  ...
  },
  {
    ...
    title: "Assumptions",
    sheet: "Assumptions",
    note: "Sector, scoring stance, Science Based Targets initiative (SBTi) net-zero year, and scoring thresholds",
    phase1: true,
    editorType: "scalar",
  },
  {
  ...
  },
  {
    ...
    sheet: "S_Data",
    note: "Training interventions by OFO occupation code, as reported in the WSP/ATR",
    phase1: true,
  ...
  },
  {
    ...
    title: "CSI / Community",
    sheet: "S_Data",
    note: "Community and social investment initiatives for the reporting period",
    phase1: true,
    editorType: "register-grid",
  },
  {
    ...
    sheet: "G_Data",
    note: "Governance maturity, rated 0–5 per item",
    phase1: true,
