/**
 * Construction Sector ΓÇö Indicator Matrices
 *
 * Source documents:
 *   - CONSTRUCTION_QUALIFYING_SMALL_ENTERPRISE_(QSE)_SCORECARD (.docx)
 *   - Construction_sector_codes (.docx)  ΓÇö Contractor and BEP scorecards
 *
 ...
 * string and the `calculation` is `evidence` ΓÇö scoring requires manual
 ...
 *  - net_value:            realisation points formula ΓÇö handled specially
...
// ---------------------------------------------------------------------------
// Construction QSE ΓÇö Total 110 (30+20+26+29+5)
// ---------------------------------------------------------------------------

const QSE_INDICATORS: ConstructionIndicator[] = [
  // Ownership ΓÇö 30 pts (5.5+2+5.5+2+7+5+1.5+1.5)
  {
  ...
  },
  {
    ...
    name: 'Bonus: Voting + Economic ΓëÑ 40%',
    description: 'Exercisable Voting Rights and Economic Interest to which Black People are entitled ΓëÑ 40%',
  ...
  },
  {
    ...
    element: 'ownership', category: 'bonus',
    name: 'Bonus: Black Women Voting + Economic ΓëÑ 12.5%',
    description: 'Exercisable Voting Rights and Economic Interest to which Black women are entitled ΓëÑ 12.5%',
    weight: 1.5, target: 12.5, targetUnit: 'percent', calculation: 'bonus_threshold',
    inputKey: 'votingAndEconomicBlackWomenPercent',
    evidenceRequired: 'Combined voting + economic interest schedule',
  },

  // Management Control ΓÇö 20 pts (5+2+6+2+4+1)
  {
  ...
  // Skills Development ΓÇö 26 pts (14+7+3+1+1)
  ...
  },
  {
    ...
    name: 'SD Expenditure on Black People (Learning Programme Matrix) ΓÇö secondary tier',
    description: 'Secondary SD Expenditure tier per the QSE scorecard. Source extraction shows target 25% ΓÇö verify against the gazetted scorecard before relying in production.',
  ...
  },
  {
    ...
    element: 'enterpriseSupplierDevelopment', category: 'main',
    name: 'PP from ΓëÑ51% Black Owned',
  ...
  },
  {
    ...
    element: 'enterpriseSupplierDevelopment', category: 'main',
    name: 'PP from ΓëÑ35% Black Women Owned',
...
// ---------------------------------------------------------------------------
// Construction Contractor ΓÇö Total 123 (31+22+26+38+6)
// ---------------------------------------------------------------------------

const CONTRACTOR_INDICATORS: ConstructionIndicator[] = [
  // Ownership ΓÇö 31 pts (4.5+2+4.5+2+3+5+6+1+2+1)
  {
  ...
  // Management Control ΓÇö 22 pts (3+1+2+1+1+1+2+1+2+0.5+1+0.5+1+0.5+0.5+2+2)
  {
  ...
  // Skills Development ΓÇö 26 pts (4+2+2+1+2+3+3+1+3+1+2+2)
  {
  ...
  // ESD (Preferential Procurement + Supplier Development) ΓÇö 38 pts (6+3+3+4+3+3+1+5+8+2)
  {
  ...
  },
  {
    ...
    name: 'Bonus: PP from ΓëÑ51% Black Designated Groups',
  ...
  },
  {
    ...
    element: 'enterpriseSupplierDevelopment', category: 'bonus',
    name: 'Bonus: PP from ΓëÑ51% Black Women Owned',
  ...
  },
  {
    ...
    element: 'enterpriseSupplierDevelopment', category: 'main',
    name: 'SD Contributions to ΓëÑ51% Black Women Owned',
...
// ---------------------------------------------------------------------------
// Construction BEP (Built Environment Professional) ΓÇö Total 123 (31+22+34+30+6)
// ---------------------------------------------------------------------------

const BEP_INDICATORS: ConstructionIndicator[] = [
  // Ownership ΓÇö 31 pts (5.5+2+5.5+2+3+5+4+1+2+1)
  ...
  // Management Control ΓÇö 22 pts (2.5+1+2.5+1+1+1+2+1+2+1+1.5+1+0.5+2+2)
  ...
  // Skills Development ΓÇö 34 pts (7+2+3+1+4+4+4+1+3+1+4)
  {
  ...
  // ESD ΓÇö 30 pts (6+3+2+4+3+2+1+4+4+1)
  {
  ...
  // SED ΓÇö 6 pts (4+1+1) ΓÇö same structure as Contractor
  {
