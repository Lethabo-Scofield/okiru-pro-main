...
// ---------------------------------------------------------------------------
// GET /api/construction/template/:entityType ΓÇö return the indicator matrix
...
router.get('/template/:entityType', (req: Request, res: Response) => {
  try {
    ...
    const cfg = getConstructionScorecard(entityType);
...
// ---------------------------------------------------------------------------
// POST /api/construction/evaluate ΓÇö score a Construction scorecard
