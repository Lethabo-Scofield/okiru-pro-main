...
const certificateMetadataSchema = new Schema({
  ...
  bbbeeLevelStatus: { type: String, default: null },
  certificateType: { type: String, default: null },
  procurementRecognition: { type: Number, default: null },
  ...
  valueAddingSupplier: { type: Boolean, default: null },
  measurementPeriod: { type: String, default: null },
  ...
  sanasAccreditationNumber: { type: String, default: null },
  commissionerDetails: { type: String, default: null },
  physicalAddress: { type: String, default: null },
  contactDetails: { type: Schema.Types.Mixed, default: null },
